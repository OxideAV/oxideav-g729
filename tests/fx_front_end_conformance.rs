...
/// overflow-shift latitude sweep. Measured under the pinned
/// configuration (overflow shift 2, truncating Q11 poly landing,
/// rounding interpolation step, Levinson numerator pre-shift):
///
/// | vector | float | fx    |
/// |--------|-------|-------|
/// | ALGTHM | 82.9% | 97.1% |
